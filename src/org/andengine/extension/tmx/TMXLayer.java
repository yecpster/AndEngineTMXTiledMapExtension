...
public class TMXLayer extends LowMemorySpriteBatch implements TMXConstants {
    ...
    public TMXTile getTMXTile(final int pTileColumn, final int pTileRow, final boolean pReturnClosestTMXTileIfOutOfBounds)
    ...
    protected void draw(final GLState pGLState, final Camera pCamera) {
        ...
        final TMXTile tmxTileMin = this.getTMXTileAt(cameraXMin - 338, cameraYMin - 277, true);
        ...
        for (int row = tileRowMin; row <= tileRowMax; row++) {
            ...
            this.mSpriteBatchVertexBufferObject.draw(GLES20.GL_TRIANGLES, spriteBatchIndex * SpriteBatch.VERTICES_PER_SPRITE, rowLength
    ...
    /* package */void initializeTMXTilesFromDataString(final String pDataString, final String pDataEncoding, final String pDataCompression,
            final ITMXTilePropertiesListener pTMXTilePropertyListener) throws IOException, IllegalArgumentException {
